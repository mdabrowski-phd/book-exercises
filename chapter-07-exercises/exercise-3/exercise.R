...
words <- c("marketing", "funeral", "phone", "cancer", "collection", "sister",
           "poet", "permission", "pollution", "clothes")
...
word_bin <- function(words, letter1, letter2) {
  words[substring(words, 1, 1) >= letter1 & substring(words, 1, 1) <= letter2]
}
