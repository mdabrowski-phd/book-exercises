...
intro_panel <- tabPanel(
  ...
  # the US."
  p("The below diagram was created by the New York Times to illustrate
    the increasing level of inequality in the US."),
  ...
  p("The graph shows how the richest 1% of people have seen their incomes jump",
    strong("6%"), "since 1980", "while the bottom 60% have barely seen any increase",
...
main_content <- mainPanel(
  ...
  p("Source:", a("http://gabriel-zucman.eu/usdina/", 
